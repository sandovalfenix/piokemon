...
export const gymLeaders: GymLeader[] = [
  {
    ...
    badgeImage: "src/assets/img/Medallas/Valle_Vivo.png",
    badgeImageTransparent: "src/assets/img/Medallas/bottomless/Valle_Vivo.png",
    type: "Roca",
    ...
    spriteUrl: "src/assets/img/Lideres/Lider_José-Cristo_Rey.png",
  ...
  },
  {
    ...
    badgeImage: "src/assets/img/Medallas/Medalla_Oleada_Viva.png",
    badgeImageTransparent: "src/assets/img/Medallas/bottomless/Medalla_Oleada_Viva.png",
    type: "Agua",
    ...
    spriteUrl: "src/assets/img/Lideres/Lider_Manuel-Parque_de_la_Caña.png",
  ...
  },
  {
    ...
    badgeImage: "src/assets/img/Medallas/Medalla_del_Ritmo_Pacífico.png",
    badgeImageTransparent: "src/assets/img/Medallas/bottomless/Medalla_del_Ritmo_Pacífico.png",
    type: "Eléctrico",
    ...
    spriteUrl: "src/assets/img/Lideres/Lider_Rafael-Plazoleta_Jairo_Varela.png",
  ...
  },
  {
    ...
    badgeImage: "src/assets/img/Medallas/El_Cielo_Sagrado.jpg",
    badgeImageTransparent: "src/assets/img/Medallas/bottomless/El_Cielo_Sagrado-Photoroom.png",
    type: "Volador",
    ...
    spriteUrl: "src/assets/img/Lideres/Lider_Sofia-La_Ermita.png",
  ...
  },
  {
    ...
    badgeImage: "src/assets/img/Medallas/Medalla_Selva_Pacífica.png",
    badgeImageTransparent: "src/assets/img/Medallas/bottomless/Medalla_Selva_Pacífica.png",
    type: "Planta",
    secondaryType: "Tierra",
    difficulty: 5,
    team: [
    ...
    spriteUrl: "src/assets/img/Lideres/Lider_Valeria-Zoológico_de_Cali.png",
